...
protected:
	...
	virtual void BeforeDraw(std::shared_ptr<Drawable>& d, WindowMaintainer* m = nullptr) = 0;
...
public:
	...
	void Draw(std::shared_ptr<Drawable>& d, WindowMaintainer* m);
    ...
    static GLuint LoadTextureFromBMPFile(const char* file_path);
    static GLuint LoadGenericTexture(const GLsizei & width, const GLsizei & height, unsigned char* data);
