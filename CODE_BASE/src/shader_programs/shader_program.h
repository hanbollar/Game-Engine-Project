...
protected:
    ...
    glm::vec2 resolution_ = glm::vec2(-1, -1);
...
public:
    ...
    // These are static (allows for easy testing)
    // - BUT all need to have glUseProgram called beforehand for them to work as expected
    ...
    static void SetUniformVec2(const glm::vec2 &vector2, const GLuint& handle);
