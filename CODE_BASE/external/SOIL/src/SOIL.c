...
// Hannah Bollar edit fix - see link: https://stackoverflow.com/questions/17923782/simple-opengl-image-library-soil-uses-deprecated-functionality //
void FILLER_GLGETSTRING() {
    GLint n, i;
